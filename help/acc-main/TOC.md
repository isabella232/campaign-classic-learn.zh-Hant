...
+ 快速入門{#getting-started}
   ...
   + [建立行銷計畫、方案和行銷活動](/help/getting-started/creating-a-marketing-plan-programs-and-campaigns.md)
...
+ 傳送訊息{#sending-messages}
   + 電子郵件通道{#email-channel}
      ...
      + [管理電子郵件中的種子和證明](/help/sending-messages/email-channel/managing-seed-and-proofs.md)
